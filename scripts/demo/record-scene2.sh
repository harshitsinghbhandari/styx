#!/usr/bin/env bash
# Resets local CockroachDB and runs Scene 2 (Cascade) for recording.
...
echo "=== STYX DEMO: Scene 2 - Cascade ==="
sleep 2
...
echo "--- running scene2-cascade ---"
cd "$ROOT"
DATABASE_URL="$DB_URL" npx tsx scripts/scenes/scene2-cascade.ts

echo "=== STYX DEMO: Scene 2 complete ==="
